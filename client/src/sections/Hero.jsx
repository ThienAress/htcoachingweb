...
const Hero = ({ images }) => {
  ...
  return (
    <section
      id="home"
      className="relative flex items-center text-left text-white overflow-hidden h-screen bg-black"
    >
      ...
      <div className="absolute top-0 left-0 w-full h-full flex items-center justify-start pl-4 sm:pl-8 md:pl-16 lg:pl-20 xl:pl-24 z-10 pointer-events-none">
        <div className="max-w-2xl lg:max-w-3xl xl:max-w-4xl mx-auto sm:mx-0 text-left pointer-events-auto px-4 sm:px-0">
          <h1 ref={titleRef} className="font-display text-3xl sm:text-4xl md:text-6xl lg:text-6xl xl:text-7xl font-extrabold uppercase leading-tight mb-4 md:mb-6" style={{ perspective: "1000px" }}>
          ...
          <ul ref={featuresRef} className="space-y-3 mb-6 md:mb-8">
          ...
          <div ref={ctaRef} className="flex flex-col sm:flex-row gap-4 sm:gap-5 mt-6 md:mt-8">
            <a
              href="#classes"
