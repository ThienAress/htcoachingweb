...
const StepBodyMetrics = ({ register, errors, bmi, waistHipRatio }) => {
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-5 md:grid-cols-2">
        <Field
          ...
          icon={Ruler}
          type="number"
          registration={register("bodyMetrics.heightCm")}
          error={errors?.bodyMetrics?.heightCm}
        ...
        <Field
          ...
          icon={Weight}
          type="number"
          registration={register("bodyMetrics.weightKg")}
          error={errors?.bodyMetrics?.weightKg}
        ...
        <Field
          ...
          icon={TrendingUp}
          type="number"
          registration={register("bodyMetrics.bodyFatPercent")}
          error={errors?.bodyMetrics?.bodyFatPercent}
        ...
        <Field
          ...
          icon={Ruler}
          type="number"
          registration={register("bodyMetrics.waistCm")}
          error={errors?.bodyMetrics?.waistCm}
        ...
        <Field
          ...
          icon={Ruler}
          type="number"
          registration={register("bodyMetrics.hipCm")}
          error={errors?.bodyMetrics?.hipCm}
        ...
        <Field
          ...
          icon={Heart}
          type="number"
          registration={register("bodyMetrics.restingHeartRate")}
          error={errors?.bodyMetrics?.restingHeartRate}
