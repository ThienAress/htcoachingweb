const ChatIcons = () => {
  return (
    <div className="fixed bottom-[100px] right-5 flex flex-col gap-2.5 z-[9999]">
      {/* Zalo */}
      <a
        href="https://zalo.me/0934215227"
        target="_blank"
        rel="noopener noreferrer"
        className="zalo w-14 h-14 bg-[#0084ff] text-white rounded-full flex items-center justify-center no-underline text-2xl shadow-md transition-transform duration-200 hover:scale-110"
      >
        <svg
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="messenger w-14 h-14 bg-[#0084ff] text-white rounded-full flex items-center justify-center no-underline text-2xl shadow-md transition-transform duration-200 hover:scale-110"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 48 48"
