---
name: known-issues
description: Danh sách vấn đề đã biết trong project. Dùng khi làm việc với file lớn, validation.js, dead code, CSP whitelist hoặc workaround có chủ đích để tránh sửa nhầm hành vi by-design.
---
