---
name: schema-change
description: Thay đổi Mongoose schema an toàn. Dùng khi thêm, sửa hoặc xóa field trong model; phải trace controllers, services, routes và validation bị ảnh hưởng.
---
