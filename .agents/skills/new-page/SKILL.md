---
name: new-page
description: Thêm trang public mới cho htcoachingweb với route, lazy import, SEO component, sitemap và prerender đầy đủ. Dùng khi tạo page cần Google index.
---
...
## Bước 9: AI SEO (llms.txt) 🤖

Nếu trang **quan trọng** (công cụ, dịch vụ, landing page):

```
// client/public/llms.txt
// Thêm vào phần "Available Pages":
- /url-route: Mô tả ngắn gọn trang (1 dòng)
```

**SKIP khi:** Trang phụ, ít traffic, hoặc trang hệ thống.

**Verify:** `llms.txt` có entry cho trang mới (nếu applicable).

---

## Bước 10: Build Verify 🏗️
...
**Verify:** Build exit 0, không có errors liên quan đến page mới.
...
[1/10] Page Component    ✅ Created với <SEO> component
[2/10] Lazy Route        ✅ Added to App.jsx
[3/10] Sitemap           ✅ Added to generate-sitemap.js
[4/10] Prerender         ✅ Added to prerender.js
[5/10] SEO Props         ✅ title, description, canonical đầy đủ
[6/10] JSON-LD           ⏭️ SKIP (không cần cho trang này)
[7/10] FAQPage Schema    ⏭️ SKIP (trang không có FAQ)
[8/10] Internal Linking  ✅ 3 links đến TDEE, Exercises, KQ KH
[9/10] AI SEO (llms.txt) ⏭️ SKIP (trang phụ)
[10/10] Build Verify     ✅ exit 0
