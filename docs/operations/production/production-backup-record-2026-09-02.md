...
Application context recorded by backup job: `f06461b01a122f5193925818b213d116859caebf`

## Scope

- Environment: production
- Database target: `gym-app`
- Backup identifier: `production-logical-backup-20260902T033930Z`
- Completed at: `2026-09-02T03:40:17.351Z`
...
- The logical archive completed with 79 collections and 4,134 documents.
...
- The isolated restore contained the same 79 collections and 4,134 documents.
...
- A cryptographically random recovery password remains locally protected by
  ...
  `HTCOACHING Production Backup Recovery - 2026-09-02` with master-password
...
- The independently restored copy contained 79 collections and 4,134 documents.
...
- The drill received no production URI and performed zero production writes. The
  ...
  ciphertext and one-time encrypted key bridge were removed; an independent
  residue check found zero remaining artifacts.
...
- The source reported MongoDB 8.0.30 while the isolated verifier ran MongoDB
  8.2.6. The restore tool emitted its cross-version compatibility warning; the
  complete document counts, per-collection counts, canonical BSON hash and
  semantic index hash nevertheless matched in both local and off-device drills.
