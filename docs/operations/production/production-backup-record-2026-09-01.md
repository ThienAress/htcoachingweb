...
Application context recorded by backup job: `a478d47ff00a0391ff5a3dee956d9beac1ea2057`

## Scope

- Environment: production
- Database target: `gym-app`
- Backup identifier: `production-logical-backup-20260901T022217Z`
- Completed at: `2026-09-01T02:23:35.634Z`
...
- The logical archive completed with 73 collections and 4,126 documents.
...
- The isolated restore contained the same 73 collections and 4,126 documents.
...
- A cryptographically random recovery password remains locally protected by
  ...
  `HTCOACHING Production Backup Recovery - 2026-09-01` with owner-confirmed
...
- The independently restored copy contained 73 collections and 4,126 documents.
