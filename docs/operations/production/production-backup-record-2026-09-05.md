...
Application context recorded by backup job: `8400529bfb0dcd4a5ce80fec29fd3491a46fdcf3`

## Scope

- Environment: production
- Database target: `gym-app`
- Backup identifier: `production-logical-backup-20260905T220244Z`
- Completed at: `2026-09-05T22:04:07.458Z`
...
- The logical archive completed with 79 collections and 4,317 documents.
...
- The isolated restore contained the same 79 collections and 4,317 documents.
...
- A cryptographically random 64-character recovery password remains locally
  ...
  Bitwarden as `HTCOACHING Production Backup Recovery - 2026-09-05` with
  master-password re-prompt enabled and verified.
...
- The independently restored copy contained 79 collections and 4,317 documents.
  Per-collection counts, canonical BSON data and semantic index fingerprints all
  matched the private source fingerprint.
- The off-device restore completed at `2026-09-06T03:12:49.933Z`.
...
- The isolated restore runtime was MongoDB 8.2.6 while the production source was
  MongoDB 8.0.32. Data, collection and semantic index fingerprints still matched,
