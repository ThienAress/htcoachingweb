...
- [x] Create and verify production backup
      ...
      [production-backup-record-2026-07-23.md](./production/production-backup-record-2026-07-23.md).
...
- [x] Wire a retained external Prometheus scrape for the protected production
      ...
      on and closes the matching open production alert issue. Changes to the
      production monitoring workflow/scripts also trigger an immediate run on
      `main`, while the recurring schedule remains enabled.
