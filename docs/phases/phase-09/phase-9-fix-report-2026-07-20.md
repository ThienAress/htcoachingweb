...
Các quyết định product/legal còn mở được ghi trong `docs/phases/phase-09/phase-9-data-inventory.md`.
...
- `docs/phases/phase-09/phase-9-data-inventory.md`
- `docs/phases/phase-09/phase-9-operations-runbook.md`
- `docs/phases/phase-09/phase-9-fix-report-2026-07-20.md`
